...
#     def __init__(self, image_size, patch_size, num_classes, hidden_dim, num_layers, num_heads, mlp_dim, attention_dropout):
#         super().__init__()
#         self.vision = vision(image_size, patch_size, num_classes, hidden_dim, num_layers, num_heads, mlp_dim, attention_dropout)
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, feat=False):
